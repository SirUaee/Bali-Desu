...
$allAnime = query("SELECT * FROM anime");
$animeOnGoing = query("SELECT * FROM anime WHERE status='On Going' ORDER BY id DESC LIMIT 15");
$animeComplated = query("SELECT * FROM anime WHERE status='Completed' ORDER BY id DESC LIMIT 10");
...
<div class="all">
    <div class="ongoing">
    On Going
    <a href="semua.php?status=On Going">On Going Lainnya</a>
    </div>
    <div class="container">

<?php foreach ($animeOnGoing as $row) : ?>
<div class="box">
...
<div class="ongoing">
    Complated
    <a href="semua.php?status=Completed">Completed Lainnya</a>
</div>
    <div class="container">
<?php foreach ($animeComplated as $row) : ?>
<div class="box">
<a href="anime.php?id=<?= $row["id"] ?>"><img src="img/<?= $row["poster"];?>"alt=""></a>
<div class="judul"><?=$row["judul"] ?></div>
<div class="episode">Episode <?=$row["total_episode"] ?></div>
